# TCPSerialChannel - low level communications routines for TCP-based serial channels, used by Protocol
# TODO: support more kinds of channels (real serial, real parallel)
